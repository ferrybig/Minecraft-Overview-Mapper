...
public class OrVariantSpecifier implements VariantSpecifier {

	private final VariantSpecifier[] specifiers;

	public OrVariantSpecifier(VariantSpecifier[] specifiers) {
	...
	public boolean equals(Object obj) {
		...
		final OrVariantSpecifier other = (OrVariantSpecifier) obj;
